...
REQUIRED_ENV: dict[str, str] = {
    ...
    "DEDUP_JUDGE_OLLAMA_BASE_URL": "http://localhost:11434",
...
class TestDefaults:
    ...
    def test_required_values_passed_through(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        assert settings.summary_ollama_base_url == "http://localhost:11434"
        assert settings.summary_model == "ornith-1.5:35b"
        assert settings.dedup_judge_ollama_base_url == "http://localhost:11434"
